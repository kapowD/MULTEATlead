...
const ProductDetail: React.FC = () => {
  ...
  // состояние корзины по этому товару
  ...
  // локальное кол-во, пока товар ещё не в корзине
  ...
  // управление количеством — без аргументов (подходит QuantityControl)
  const increase = () => {
    if (inCart) {
  ...
  const decrease = () => {
    if (inCart) {
      const next = Math.max(1, cartItem!.quantity - 1);
      ...
      <div className={styles.container}>
        ...
        <div className={styles.productLayout}>
          ...
          <div className={styles.infoSection}>
            ...
            {/* Жёлтый блок цены + управление покупкой */}
            ...
            {/* старый блок actions убрал, т.к. кнопка и счётчик теперь выше */}
          </div>
        </div>
      </div>
    </div>
