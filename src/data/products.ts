...
Применение навесных и потолочных вентиляторов позволит выравнивать температуру даже при высоких потолках.`,
    ...
    },
    {
        ...
        name: "Дымоходы",
        category: "parts",
        image: Mjtt20KronshteinShiber,
        images: [Mjtt20KronshteinShiber, Mjtt20RabotaShiber, Mjtt20Vbitu],
        imageDescriptions: [
            "Элементы дымохода для комплектации отопителей MULTEAT.",
            "Пример узла крепления и регулировки тяги.",
            "Пример установки оборудования с дымоходом в бытовом помещении.",
        ],
        inStock: true,
        warranty: "Под заказ",
        price: 0,
        description: "Комплектуемые элементы дымохода диаметром 120 или 140 мм",
        fullDescription:
            "Подберите элементы дымохода через конструктор: выберите диаметр, наименование и количество. После проверки списка добавьте конфигурацию в корзину.",
        constructorType: "chimney",
        specifications: {
            "Доступные диаметры": "120 мм, 140 мм",
            Позиции: "трубы, углы, тройник, стакан, зонт, усиленный хомут",
